#!/usr/bin/env python3
"""
SNIPS Dataset Training Script
============================

This script trains a custom intent classification model on the SNIPS dataset.
SNIPS is one of the most popular and reliable intent classification datasets.

Usage:
    python training/train_snips.py
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('training/logs/snips_training.log'),
...
class SNIPSTrainer:
    """SNIPS Dataset Trainer"""
    
    def __init__(self, config: Dict):
        """
        Initialize SNIPS trainer
    ...
    def load_snips_dataset(self) -> Dict:
        """
        Load and preprocess SNIPS dataset
        
        Returns:
            Dictionary containing train, validation, and test datasets
        """
        logger.info("Loading SNIPS dataset...")
        
        try:
            # Load SNIPS dataset from Hugging Face
    ...
    def preprocess_data(self, dataset: Dict) -> Tuple[Dataset, Dataset, Dataset]:
        """
        Preprocess SNIPS data for training
        
        Args:
            dataset: Raw SNIPS dataset
            
        Returns:
            Tuple of (train_dataset, val_dataset, test_dataset)
        """
        logger.info("Preprocessing SNIPS data...")
        
        # Use the provided train/validation/test splits
    ...
    def train_model(self):
        ...
        # Save the model
        model_save_path = Path(self.config['output_dir']) / "snips_intent_classifier"
    ...
    def run_training(self):
        ...
        logger.info("🚀 Starting SNIPS training pipeline...")
        
        try:
            # Step 1: Load dataset
            dataset = self.load_snips_dataset()
            ...
            logger.info("🎉 SNIPS training completed successfully!")
